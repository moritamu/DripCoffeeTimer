...
//            Text("はじめのお湯の量: " + String(format: "%.1f", dripData.hotWT * 0.2))
            Text("はじめのお湯の量: " + String(format: "%.1f", dripData.ArrayHotW[0]))
                .padding([.bottom, .trailing])
//            Text("２回目のお湯の量: " + String(format: "%.1f", dripData.hotWT * 0.4))
            Text("２回目のお湯の量: " + String(format: "%.1f", dripData.ArrayHotW[1]))
                .padding([.bottom, .trailing])
//            Text("３回目のお湯の量: " + String(format: "%.1f", dripData.hotWT))
            Text("３回目のお湯の量: " + String(format: "%.1f", dripData.ArrayHotW[2]))
                .padding([.bottom, .trailing])
            Spacer()
